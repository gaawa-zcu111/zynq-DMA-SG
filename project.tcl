...
#
# Generated by Vivado on Thu May 23 10:37:54 +0200 2024
...
#
#    "C:/git-zcu111/zynq_dma_sg/ip/zynq_dma_sg/hdl/zynq_dma_sg_wrapper.vhd"
#    "C:/git-zcu111/zynq_dma_sg/constrs/ddr4_constr.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ip/zynq_dma_sg/hdl/zynq_dma_sg_wrapper.vhd"]"\
 "[file normalize "$origin_dir/constrs/ddr4_constr.xdc"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/ip/zynq_dma_sg/hdl/zynq_dma_sg_wrapper.vhd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zynq_dma_sg_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/constrs/ddr4_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constrs/ddr4_constr.xdc"
set file [file normalize $file]
...
# Proc to create BD zynq_dma_sg
proc cr_bd_zynq_dma_sg { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zynq_dma_sg
  ...
  set_property USER_COMMENTS.comment_0 "BRAM memory for scatter gather (SG) buffer descriptors (BD)" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_1 "Reading this DDR Memory in loop via DMA and SG." [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_2 "Set up SG BD and initiate DMA MM2S loop via Zynq" [get_bd_designs $design_name]
  set_property USER_COMMENTS.comment_3 "Observe DMA operation via ILA" [get_bd_designs $design_name]
  ...
  set ddr4_sdram [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ddr4_rtl:1.0 -portmaps { \
   ...
   BG { physical_name ddr4_sdram_bg direction O left 0 right 0 } \
   CK_C { physical_name ddr4_sdram_ck_c direction O left 0 right 0 } \
   CK_T { physical_name ddr4_sdram_ck_t direction O left 0 right 0 } \
   CKE { physical_name ddr4_sdram_cke direction O left 0 right 0 } \
   CS_N { physical_name ddr4_sdram_cs_n direction O left 0 right 0 } \
   ...
   ODT { physical_name ddr4_sdram_odt direction O left 0 right 0 } \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_SG] [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins axi_smc_1/S01_AXI]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tkeep [get_bd_pins axi_dma_0/m_axis_mm2s_tkeep] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins rst_ddr4_0_333M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  ...
  connect_bd_net -net rst_ddr4_0_333M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins rst_ddr4_0_333M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins xlconstant_0/dout]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  ...
  exclude_bd_addr_seg -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.539397",
   "Default View_TopLeft":"-154,-80",
   "ExpandedHierarchyInLayout":"",
   "comment_0":"BRAM memory for scatter gather (SG) buffer descriptors (BD)",
   "comment_1":"Reading this DDR Memory in loop via DMA and SG.",
   "comment_2":"Set up SG BD and initiate DMA MM2S loop via Zynq",
   "comment_3":"Observe DMA operation via ILA",
...
#  -string -flagsOSRD
preplace port ddr4_sdram -pg 1 -lvl 5 -x 1880 -y 630 -defaultsOSRD
preplace port default_sysclk1_300mhz -pg 1 -lvl 0 -x 0 -y 310 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x 0 -y 330 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 1310 -y 80 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 4 -x 1680 -y 80 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -x 860 -y 500 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 860 -y 200 -defaultsOSRD
preplace inst axi_smc_1 -pg 1 -lvl 3 -x 1310 -y 670 -defaultsOSRD
preplace inst ddr4_0 -pg 1 -lvl 4 -x 1680 -y 680 -defaultsOSRD
preplace inst rst_ddr4_0_333M -pg 1 -lvl 1 -x 340 -y 580 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 4 -x 1680 -y 360 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -x 860 -y 690 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 210 -defaultsOSRD
preplace netloc axi_dma_0_m_axis_mm2s_tdata 1 2 2 1090 340 N
preplace netloc axi_dma_0_m_axis_mm2s_tkeep 1 2 2 1120 360 N
preplace netloc axi_dma_0_m_axis_mm2s_tlast 1 2 2 1150 380 N
preplace netloc axi_dma_0_m_axis_mm2s_tvalid 1 2 2 1160 400 N
preplace netloc ddr4_0_c0_ddr4_ui_clk 1 0 5 20 300 640 320 1140 240 1470 240 1860J
preplace netloc ddr4_0_c0_ddr4_ui_clk_sync_rst 1 0 5 20 770 NJ 770 1160J 570 NJ 570 1850J
preplace netloc reset_1 1 0 4 NJ 330 NJ 330 NJ 330 1450J
preplace netloc rst_ddr4_0_333M_peripheral_aresetn 1 1 3 650 760 1130 420 1470
preplace netloc xlconstant_0_dout 1 2 1 1060 530n
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 N 70
preplace netloc axi_bram_ctrl_0_BRAM_PORTB 1 3 1 N 90
preplace netloc axi_dma_0_M_AXI_MM2S 1 2 1 1100 430n
preplace netloc axi_dma_0_M_AXI_SG 1 1 3 660 300 1080J 300 N
preplace netloc axi_smc_1_M00_AXI 1 3 1 N 670
preplace netloc axi_smc_M00_AXI 1 2 1 1070 60n
preplace netloc axi_smc_M01_AXI 1 1 2 660 750 1070
preplace netloc axi_smc_M02_AXI 1 2 1 1110 220n
preplace netloc ddr4_0_C0_DDR4 1 4 1 N 630
preplace netloc default_sysclk1_300mhz_1 1 0 4 NJ 310 NJ 310 NJ 310 1460J
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 660 170n
preplace cgraphic comment_3 place right -446 186 textcolor 4 linecolor 3
preplace cgraphic comment_2 place top 124 45 textcolor 4 linecolor 3
preplace cgraphic comment_1 place right -489 516 textcolor 4 linecolor 3
preplace cgraphic comment_0 place top 1437 -52 textcolor 4 linecolor 3
levelinfo -pg 1 0 340 860 1310 1680 1880
pagesize -pg 1 -db -bbox -sgen -210 0 2010 790
",
   "linktoobj_comment_0":"",
   "linktoobj_comment_1":"",
   "linktoobj_comment_2":"",
...
# End of cr_bd_zynq_dma_sg()
cr_bd_zynq_dma_sg ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zynq_dma_sg.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynq_dma_sg.bd ] 
